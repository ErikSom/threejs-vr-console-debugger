...
var CanvasInput = window.CanvasInput = function(o) {
	...
	self._ctx = self._canvas ? self._canvas.getContext('2d', {alpha:false}) : null;
	self._x = o.x || 0;
	self._y = o.y || 0;
	self._extraX = o.extraX || 0;
	self._extraY = o.extraY || 0;
	self._fontSize = o.fontSize || 16;
	...
	self._renderCtx = self._renderCanvas.getContext('2d', {alpha:false});
	...
	self._shadowCtx = self._shadowCanvas.getContext('2d', {alpha:false});
...
CanvasInput.prototype = {
	...
	if (typeof data !== 'undefined') {
		self._canvas = data;
		self._ctx = self._canvas.getContext('2d', {alpha:false});
